...
class EndPlotGenerator extends Generator {
	/** @var Block $roadBlock */
	protected $roadBlock;
	...
	protected $wallBlock;
	/** @var int $roadWidth */
	protected $roadWidth = 11;
	/** @var int $groundHeight */
	protected $groundHeight = 50;
	/** @var int $plotSize */
	protected $plotSize = 128;
	public const PLOT = 0;
	public const ROAD = 1;
	public const WALL = 2;
	public const NAME = 'plot:end';
	...
	public function __construct(int $seed, string $preset) {
		...
		$this->roadBlock = VanillaBlocks::END_STONE_BRICKS();
		$this->wallBlock = VanillaBlocks::PURPUR_SLAB();
		$this->plotFloorBlock = VanillaBlocks::END_STONE();
		$this->plotFillBlock = VanillaBlocks::END_STONE();
