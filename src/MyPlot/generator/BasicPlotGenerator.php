...
class BasicPlotGenerator extends Generator {
	/** @var Block $roadBlock */
	protected $roadBlock;
	...
	/** @var int $plotSize */
	protected $plotSize = 64;
	public const PLOT = 0;
	public const ROAD = 1;
	public const WALL = 2;
	public const NAME = 'plot:basic';
	...
	public function __construct(int $seed, string $preset) {
		...
		$this->roadBlock = VanillaBlocks::OAK_PLANKS();
		$this->wallBlock = VanillaBlocks::SMOOTH_STONE_SLAB();
		$this->plotFloorBlock = VanillaBlocks::GRASS();
		$this->plotFillBlock = VanillaBlocks::DIRT();
